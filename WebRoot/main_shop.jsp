...
%>
  <tr>
    ...
    <td height="30%" align="center"><a href="./WebRoot/Buy.jsp?sid=<%= ss[i][0] %>&action=buy">购买</a></td>
  </tr>
<%			
		}
 ...
 <%
  ...
  %>
     ...
     <a href="./WebRoot/main_shop.jsp?cp=<%=currpage-1%>">上一页</a>
  ...
  <%
   ...
   {   
%>
  <a href="./WebRoot/main_shop.jsp?cp=<%=currpage+1%>">下一页</a>
<%      
   } 
  %>   
...
<%    
 ...
 %>
    ...
    <div class="register">
     ...
     <button onclick="window.location.href='./WebRoot/Cart.jsp'">查看购物车</button>
    </div>
